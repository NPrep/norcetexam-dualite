    ...
    <section className="bg-white py-16 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="prose prose-slate max-w-none lg:prose-lg">
          ...
          <p>
            <a href={NPREP_LINKS.home} className="text-blue-600 font-bold hover:underline">NPrep</a> presents a detailed table for the eligibility criteria for various Nursing Exams in 2026. The following table outlines the age, educational qualifications, and specific requirements for each major nursing exam.
          </p>
          <div className="overflow-x-auto my-8 not-prose">
            <table className="min-w-full border border-gray-200 shadow-sm rounded-lg overflow-hidden">
